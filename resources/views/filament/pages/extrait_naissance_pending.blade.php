            ...
            <x-filament::card>
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-semibold">{{ \App\Models\ActeNaissance::where('status', 0)->count() }}</p>
                    </div>
            ...
            <x-filament::card>
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-semibold">{{ \App\Models\ActeNaissance::where('status', 100)->count() }}</p>
                    </div>
            ...
            <x-filament::card>
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-semibold">{{ \App\Models\ActeNaissance::where('status', 200)->count() }}</p>
                    </div>
