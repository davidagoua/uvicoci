...
use App\Filament\Pages\reservation_date_mariage\ReservationActeNaissanceDetail;
...
class copie_acte_naissance_livraison extends Page implements  HasTable
{
    //protected static ?string $navigationIcon = 'heroicon-o-document-text';
    protected static ?string $navigationGroup = "Livraisons";
    protected static string $view = 'filament.pages.copie_acte_naissance_livraison';
    ...
    {
        return ActeNaissance::query()->whereStatus(600)->count();
    }

    public function query(): Builder
    {
        return ActeNaissance::query()->whereStatus(600);
    }

    public function table(Table $table): Table
    {
        return $table
            ->query(ActeNaissance::query()->orderBy('created_at', 'desc')->whereStatus(600))
            ->columns([
            ...
            ->actions([
                \Filament\Tables\Actions\Action::make('consulter')
                    ->button()
                    ->url(fn ($record) => ReservationActeNaissanceDetail::getUrl(['id'=>$record->id]))
                    ->icon('heroicon-o-eye'),
