...
class reservation_date_mariage_scan extends Page implements HasTable
{
    // protected static ?string $navigationIcon = 'heroicon-o-document-text';
    protected static ?string $navigationGroup = "Scans";
    protected static ?string $title = "Reservation Date Mariage";
    protected static ?string $navigationLabel = "Reservation Date Mariage";
    protected static string $view = 'filament.pages.reservation_date_mariage_scan';
