...
class acte_deces_sign extends Page implements HasTable
{
    protected static ?string $navigationGroup = "Signature & Timbre";
    protected static string $view = 'filament.pages.acte_deces_sign';
    ...
    {
        return ActeDeces::query()->whereStatus(300)->count();
    }

    public function query(): Builder
    {
        return ActeDeces::query()->whereStatus(300);
    }

    public function table(Table $table): Table
    {
        return $table
            ->query(ActeDeces::query()->orderBy('created_at', 'desc')->whereStatus(300))
            ->columns([
